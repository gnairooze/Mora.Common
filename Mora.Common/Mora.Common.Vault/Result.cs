...
namespace Mora.Common.Vault
{
    public class Result
    {
        ...
        public const string RESULT_GENERAL_TECH_DESCRIPTION = "general technical error";

        public const string RESULT_GENERAL_BUSINESS_ERROR_CODE = "-3";
        public const string RESULT_GENERAL_BUSINESS_DESCRIPTION = "general business error";
